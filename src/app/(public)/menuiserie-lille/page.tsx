    ...
    <>
      ...
      <section className="bg-noir text-white py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <p className="text-bois-clair text-sm font-medium tracking-widest uppercase mb-3">Atelier Cysoing — Métropole lilloise</p>
          <h1 className="text-4xl lg:text-5xl font-bold mb-4">Menuiserie sur mesure à Lille</h1>
          <p className="text-white/80 text-lg max-w-2xl">
            Fabrication artisanale de meubles, dressings, cuisines et agencements en bois massif. Atelier à Cysoing, interventions dans tout le Nord.
          </p>
        </div>
      </section>
      ...
      {services.length > 0 && (
        <section className="py-20 bg-beige/50">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <h2 className="text-2xl font-bold text-noir text-center mb-10">Nos services à Lille et environs</h2>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-noir text-center mb-12">Pourquoi choisir Au Format à Lille ?</h2>
      ...
      <section className="py-20 bg-beige/50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl font-bold text-noir mb-6">Notre atelier à Cysoing</h2>
            ...
            <div className="rounded-xl overflow-hidden shadow-md aspect-[4/3]">
              <iframe
                title="Atelier Au Format Cysoing"
                src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2535!2d${loc.lng}!3d${loc.lat}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNTDCsDM0JzE2LjAiTiAzwrAxMic0Ni4xIkU!5e0!3m2!1sfr!2sfr`}
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-noir text-center mb-8">Zone d&apos;intervention autour de Lille</h2>
          <p className="text-noir/70 text-center mb-8">
            Nous intervenons dans un rayon de 50 km autour de notre atelier de Cysoing, couvrant l&apos;ensemble de la métropole lilloise et du département du Nord.
          </p>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
          <p className="text-noir/70 text-sm">
            Vous êtes sur la Côte d&apos;Opale ?{' '}
            <Link href="/menuiserie-le-touquet" className="text-vert-foret font-semibold hover:underline">
              Découvrez notre atelier à La Calotterie, près du Touquet →
            </Link>
          </p>
        </div>
      </section>
      ...
      <section className="bg-vert-foret py-20">
        <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Un projet de menuiserie à Lille ?</h2>
          <p className="text-white/80 mb-8 text-lg">Contactez-nous pour un devis gratuit et sans engagement. Déplacement offert dans toute la métropole lilloise.</p>
